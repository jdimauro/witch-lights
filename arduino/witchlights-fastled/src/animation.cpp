...
// 12345678901234567890123 strcpy(afc_w8v1, "					123456788
...
// 12345678901234567890123 strcpy(afc_w8v1r, "		 887654321
"); strcat(afc_w8v1r, "		 88654321						");
          ...
          //
12345678901234567890123 strcpy(afc_2_sparkle_a, "123456788
...
*/
  ...
  //
  // These always start with pixels 11 and 12 (counting from 0) at 8, and return to the same
  // position.

  //											123456789012345678901234
  strcpy(afc_l_pulsar_a,
         "					 88						");
  strcat(afc_l_pulsar_a,
         "					1881					");
  strcat(afc_l_pulsar_a,
         "					2882					");
  ...
  // The plan is to cut them into "intro" and "outro" animations, with loop animations inserted in
  // between Hopefully we can have enough SRAM for multiple "intro" and "outro" animations, so that
  // the motion doesn't become predictable. Also, incorporating auto-trails and controllable
  // acceleration factors in UpdateTravel methods means that we reduce the number of frames of
  // animation that we have to render into RAM.
