...
bool spawnFaeries = true;   // TODO Spawn a new faerie randomly; helpful to keep a constant
                            // background of sprite animation for evaluation
bool placeLurkers = false;  // TODO Dimly lights up range of pixels where lurkers are "allowed" to
                            // spawn, for install time
bool placeTrees =
    false;  // TODO Dimly lights up range of pixels green where trees are defined, also for installs
...
// TODO: State machine blink sprites that spawn in defined areas when TravelSprites pass through
// them. "Spirits awaken"
